...
| CC-MATH-03 | 미분·chain rule·gradient·autodiff를 손계산, 계산 그래프, 코드의 gradient 흐름으로 연결한다. | D2 | CC-MATH-01 | explain, calculate, shape, implement, debug | primary:SRC-KBM-07-01,SRC-KBM-07-02; supporting:SRC-KDL-01-04 | 부분 | 수업 내 보충 | Jacobian·vector-Jacobian product와 체계적인 gradient check가 없다. |
| CC-MATH-04 | 부동소수점, overflow·underflow, conditioning과 안정적인 연산 선택을 계산·디버깅에 적용한다. | D2 | CC-MATH-02, CC-MATH-03 | explain, calculate, implement, debug, interpret | supporting:SRC-KBM-01-04,SRC-KBM-02-03,SRC-KBM-04-01,SRC-KBM-04-02,SRC-KBM-06-02,SRC-KBM-07-01,SRC-KDL-02-03 | 부분 | 수업 내 보충 | 안정적 softmax 등 단편은 있으나 conditioning·precision·오차 전파의 통합 설명이 없다. |
...
| CC-ML-01 | 문제 유형을 정의하고 train·validation·test 분리와 단순 baseline을 설계한다. | D2 | CC-PROB-01 | explain, implement, interpret, design | primary:SRC-KAM-01-01,SRC-KDL-01-02,SRC-KDL-01-03; supporting:SRC-KAM-04-02 | 충분 | 그대로 사용 | 시간·그룹 데이터의 분리 선택까지 포함한다. |
...
| CC-SYS-01 | GPU 연산·메모리·대역폭·precision·profiling의 병목을 측정하고 해석한다. | D2 | CC-DL-01 | explain, calculate, implement, debug, interpret | supporting:SRC-KDL-02-03,SRC-KDL-02-04 | 부분 | 수업 내 보충 | device 이동은 있으나 memory hierarchy·kernel·AMP·profiler가 없다. |
...
| CC-RES-03 | 재현 절차·artifact·환경·부정적 결과·한계를 검증 가능하게 보고한다. | D3 | CC-RES-01, CC-ML-05 | explain, implement, debug, interpret, design, transfer | context:SRC-KAM-05-02 | 없음 | 별도 자료 확보 | 모델 저장·재로드는 있으나 연구 재현 패키지와 한계 보고가 없다. |
...
7. 기본 구조 검증은 `python3 .agents/skills/coach-llm-research-study/scripts/validate_curriculum.py`로, private 자료·hash·index parity까지 포함한 검증은 같은 명령에 `--strict-sources`를 붙여 실행한다.
