...
- 현재 강의: Chapter 2, §2.7.3 Image and Kernel, 인쇄 쪽 58부터
- 공식 자료: https://mml-book.github.io/
- 공식 PDF: https://mml-book.github.io/book/mml-book.pdf
- 연결 실습: Exercise 2.19(a) 피드백 후 단사·전사와 차원 관계 연결; Exercise 2.20(a)의 그림은 미확인
...
다음은 §2.7.3에서 전사와 상의 관계, 입력·출력 차원이 같을 때의
단사·전사 동치를 연결하는 것이다. 이후 §2.8 아핀 공간으로 이어간다.
